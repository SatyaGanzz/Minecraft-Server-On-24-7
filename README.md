# 🤖 Aternos / Free Server / Free 24/7 Hosting Bot

A Minecraft bot that helps keep an Free server online 24/7 by automatically joining it using a Mineflayer-based bot. Perfect for SMPs or small multiplayer servers that shut down when no players are online.
...
## ⚙️ Usage
*   **Start**: Just turn on your Aternos / Free server. The bot will join automatically.
...
## ⚠️ Disclaimer
This project is not affiliated with Aternos / Free, Mojang, or Microsoft. Use at your own risk. Misuse may violate platform terms of service. This bot does not bypass Aternos / Free queue limits; it only keeps the server active once it is online.
