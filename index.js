...
// ============================================================
// EXPRESS SERVER - Keep Render/Aternos / Free alive
// ============================================================
const app = express();
  ...
  res.send(`
    <html>
      ...
      <body>
        ...
        <div class="card">
          <h2>Step 1: Configure Aternos / Free</h2>
          <ol>
            <li>Go to <strong>Aternos / Free</strong>.</li>
...
function createBot() {
  ...
  try {
    bot = mineflayer.createBot({
      ...
      hideErrors: false,
      checkTimeoutInterval: 300000 // 5 minutes - extra tolerance for laggy Aternos / Free servers
    });
...
function initializeModules(bot, mcData, defaultMove) {
  ...
  // Periodic Rejoin - REMOVED (was causing Aternos / Free to stop the server)
